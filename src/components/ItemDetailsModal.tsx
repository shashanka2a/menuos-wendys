...
const bases = [
  { id: "bun", name: "Fresh Bun", price: 0 },
  { id: "lettuce-wrap", name: "Lettuce Wrap", price: 0 },
  { id: "no-bun", name: "No Bun", price: 0 },
];

const proteins = [
  { id: "beef", name: "Fresh Beef Patty", price: 0 },
  { id: "chicken", name: "Grilled Chicken", price: 0 },
  { id: "crispy-chicken", name: "Crispy Chicken", price: 0 },
  { id: "bacon", name: "Applewood Smoked Bacon", price: 1.5 },
];

const addons = [
  { id: "lettuce", name: "Fresh Lettuce", price: 0 },
  { id: "tomato", name: "Fresh Tomato", price: 0 },
  { id: "onion", name: "Red Onion", price: 0 },
  { id: "pickles", name: "Dill Pickles", price: 0 },
  { id: "cheese", name: "American Cheese", price: 0.5 },
...
export function ItemDetailsModal({
  ...
  const [selectedBase, setSelectedBase] = useState("bun");
